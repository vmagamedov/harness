...
_CONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='server', full_name='example.Configuration.server', index=5,
